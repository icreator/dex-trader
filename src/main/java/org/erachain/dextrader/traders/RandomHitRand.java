 ...
 */
public class RandomHitRand extends Trader {
    ...
    protected boolean createOrder(BigDecimal schemeAmount) {
        ...
        BigDecimal randomAmount = schemeAmount.multiply(new BigDecimal(1.0 + 0.001 * randInt).setScale(5, RoundingMode.UP));

        if (randomAmount.signum() > 0) {
